...
const { listarTipoContratacion, listarTipoInstrumento, agregarContratacion, agregarAnexo, listarContratacion, listarContratacionBack, borrarContratacion, editarContratacion, editarAnexo, listarContratacionPorId } = require("../controllers/adminControllers");
const fs = require('fs');
const router = Router();
